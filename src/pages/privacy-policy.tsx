    ...
    <>
      ...
      <section class={`${sections.common}`}>
        ...
        <BlogWrapper>
          ...
          <p>
            Saeed Hossen follows a standard procedure of using log files. These
          ...
          <p>
            Like any other website, our website uses 'cookies'. These cookies
          ...
          <p>
            ...
            advertising partners of our website. Third-party ad servers or ad
            ...
            appear on this website, which are sent directly to users' browser.
            ...
            that you see on websites that you visit. Note that our website has
            no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <h3 class="text-3xl my-4">Third Party Privacy Policies</h3>
          <p>
            This website Privacy Policy does not apply to other advertisers or
          ...
          <p>
            ...
            Learn With Rabbil does not knowingly collect any Personal
