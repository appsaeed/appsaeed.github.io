      ...
      <section class={`${sections.common}`}>
        ...
        <div class="mx-10 my-20 p-10 bg-slate-700 rounded-lg">
          ...
          <p>
            ...
            by Saeed Hossen and how we use it. If you have additional questions or require
            more information about our Privacy Policy, do not hesitate to{" "}
            <Link href={`${settings.url}/#contact`}>contact us</Link>.This Privacy Policy
            applies only to our online activities and is valid for visitors to our website
            with regards to the information that they shared and/or collect in Learn With
            Rabbil. This policy is not applicable to any information collected offline or
            via channels other than this website.
          </p>
          <h3 class="text-3xl my-4">Consent</h3>
          <p>
            By using our website, you hereby consent to our Privacy Policy and agree to
            its terms.
          </p>
          <h3 class="text-3xl my-4">Information we collect</h3>
          <p>
            ...
            Account, we may ask for your contact information, including items such as
            name, company name, address, email address, and telephone number.
          </p>
          <h3 class="text-3xl my-4">How we use your information</h3>
          <p>We use the information we collect in various ways, including to:</p>
          <ul class="space-y-1 text-gray-700 list-disc list-inside dark:text-gray-300 my-2">
          ...
          <h3 class="text-3xl my-4">Log Files</h3>
          <p>
            Saeed Hossen follows a standard procedure of using log files. These files log
          ...
          <h3 class="text-3xl my-4">Cookies & Session and storage</h3>
          <p>
            Like any other website, our website uses 'cookies'. These cookies are used to
          ...
          <h3 class="text-3xl my-4">Advertising Partners Privacy Policies</h3>
          <p>
            You may consult this list to find the Privacy Policy for each of the
            advertising partners of our website. Third-party ad servers or ad networks
            uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on this website, which
            are sent directly to users' browser. They automatically receive your IP
            address when this occurs. These technologies are used to measure the
            effectiveness of their advertising campaigns and/or to personalize the
            advertising content that you see on websites that you visit. Note that our
            website has no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <h3 class="text-3xl my-4">Third Party Privacy Policies</h3>
          <p>
            This website Privacy Policy does not apply to other advertisers or websites.
            ...
            choose to disable cookies through your individual browser options. To know
          ...
          <h3 class="text-3xl my-4">Children's Information</h3>
          <p>
            Another part of our priority is adding protection for children while using the
            internet. We encourage parents and guardians to observe, participate in,
            and/or monitor and guide their online activity. Learn With Rabbil does not
            ...
            on our website, we strongly encourage you to contact us immediately and we
